...
import 'package:kisaan_vaani/screens/Report page.dart'; // Ensure you have the correct import for your ReportPage
                          ...
                          Table(
                            ...
                            children: [
                              ...
                              TableRow(children: [
                                ...
                                TableCell(child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('10 mg/kg'), // Replace with actual data
                                )),
                              ]),
                              TableRow(children: [
                                TableCell(child: Padding(
                                ...
                                TableCell(child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('20 mg/kg'), // Replace with actual data
                                )),
                              ]),
                              TableRow(children: [
                                TableCell(child: Padding(
                                ...
                                TableCell(child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('15 mg/kg'), // Replace with actual data
                                )),
                              ]),
                              TableRow(children: [
                                TableCell(child: Padding(
                                ...
                                TableCell(child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('30%'), // Replace with actual data
                                )),
                              ]),
                              TableRow(children: [
                                TableCell(child: Padding(
                                ...
                                TableCell(child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('6.5'), // Replace with actual data
                                )),
                              ]),
                              TableRow(children: [
                                TableCell(child: Padding(
                                ...
                                TableCell(child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('25°C'), // Replace with actual data
                                )),
                              ]),
                              TableRow(children: [
                                TableCell(child: Padding(
                                ...
                                TableCell(child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('40%'), // Replace with actual data
                                )),
                              ]),
                            ],
                          ),
